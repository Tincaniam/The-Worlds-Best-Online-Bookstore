...
var db = require('./db-connector'); // Routes
...
router.get('/books_authors', function (req, res) {
  res.sendFile(path.join(__dirname + '/public/books_authors/books_authors.html'));
});
router.get('/books_orders', function (req, res) {
...
app.listen(PORT);
console.log('Express started on http://localhost:' + PORT + '; press Ctrl-C to terminate.'); // app.listen(PORT, function(){            // This is the basic syntax for what is called the 'listener' which receives incoming requests on the specified PORT.
